      ...
      <LampContainer>
        ...
        >
          ...
          <p className="mt-4 max-w-2xl text-lg text-gray-300 md:text-xl">
            Unlock exclusive tools like TikTok Ads, Google Ads, and a dedicated account manager to take your brand to new heights.
          </p>
      ...
      <MaxWidthWrapper className="py-20">
        ...
        <AnimationContainer delay={0.1} className="w-full mb-20">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {vipBenefits.slice(0, 3).map((benefit, index) => (
